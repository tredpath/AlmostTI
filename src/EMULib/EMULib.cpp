...
#if defined(WINDOWS) || defined(UNIX) || defined(MAEMO) || defined(__QNXNTO__)
...
#if defined(UNIX) || defined(MAEMO) || defined(__QNXNTO__)
...
/*************************************************************/
void (*KeyHandler)(unsigned int Key, int pressed) = 0;
...
#if defined(UNIX) || defined(MAEMO) || defined(NXC2600) || defined(STMP3700) || defined(__QNXNTO__)
...
/*************************************************************/
void SetKeyHandler(void (*Handler)(unsigned int Key, int pressed))
{
  KeyHandler=Handler;
}
