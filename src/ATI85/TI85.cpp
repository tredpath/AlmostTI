...
char *ProgDir  = 0;          	   /* Program directory      */
...
const TIConfig Config[] =
{
  ...
  /*{ ATI_TI83SE,"TI83SE.png", "TI83SEq.png","TI83SE.ROM",0x200000,"shared/misc/TI/RAM/TI83SE.RAM",0x20000 },
  { ATI_TI84P, "TI84P.png", "TI84Pq.png", "TI84P.ROM", 0x100000,"shared/misc/TI/RAM/TI84P.RAM", 0x20000 },
  { ATI_TI84SE,"TI84SE.png", "TI84SEq.png","TI84SE.ROM",0x200000,"shared/misc/TI/RAM/TI84SE.RAM",0x20000 },*/
  { 0,0,0,0,0,0 }
};
char TIFilename[10];
...
{
#ifdef __BBTEN__
	extern int getROMType(const char* path, int &M);
	return getROMType(FileName, M);
#else
